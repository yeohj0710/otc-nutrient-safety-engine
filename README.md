...
- 사용자 지시로 production 에 배포했다. 공개 주소는 https://otc-nutrient-safety-engine.vercel.app 이고 배포 ID 는 dpl_A1YDFPUijJCXWnVKdojUxP4pEZvn 다. 사이트 배포는 연구 상태 플래그 release_ready 와 별개이며 release_ready 는 임상 배포 승인 절차를 뜻하므로 false 를 유지한다.
